...
import blue_b_ico1 from './images/blue_b_ico1.png';
import blue_b_ico2 from './images/blue_b_ico2.png';
import blue_b_ico3 from './images/blue_b_ico3.png';
import blue_b_ico4 from './images/blue_b_ico4.png';
...
export default () => {
  ...
  //     .removeClass('checked');
  // });
  document.getElementById('page4').innerHTML = `    <div class="content">
<div class="box">
  <div class="titlebox">
    <h3>历史累计数据统计</h3>
  </div>
